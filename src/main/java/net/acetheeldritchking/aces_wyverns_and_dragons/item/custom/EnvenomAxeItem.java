...
public class EnvenomAxeItem extends AxeItem {

    public EnvenomAxeItem(Tier pTier, float pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
